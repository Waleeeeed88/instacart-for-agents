...
const PROTEIN_ANCHOR_TERMS = /\b(chicken|turkey|beef|fish|tuna|egg|greek yogurt|cottage cheese|tofu|lentil|bean|chickpea|edamame|protein)\b/i;
...
export function isProteinAnchor(value: string): boolean {
  return PROTEIN_ANCHOR_TERMS.test(value);
}
